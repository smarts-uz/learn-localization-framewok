...
var render$4 = function(type, props, queue) {
  ...
  try {
    return React.createElement(type._init(type._payload), props);
  } catch (err) {
...
var render$1 = function(type, props, queue, clientRefVisitor, element) {
  try {
    ...
    return React.createElement(React__default["default"].Fragment, {}, [].concat(node ? getChildrenArray(node) : Object.values(props).flat(Infinity).filter(_ref$1)));
  } catch (error) {
    if (typeof error.then !== "function") {
...
var ref = React__default["default"].__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
   ...
   case REACT_MEMO_TYPE:
    {
      ...
      var child$1 = React.createElement(type$2, memoElement.props);
