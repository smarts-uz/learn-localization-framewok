...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: J9EeM4KTm13r/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: jdwti-cgKfbu/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___8V8Sd)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___7Z9Fs)}
              />
            </React.Fragment>
          ),
          value: args.children
